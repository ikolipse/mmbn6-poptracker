...
megaman_battle_network_6_location = {}
megaman_battle_network_6_location.__index = megaman_battle_network_6_location
...
---@type table<string, megaman_battle_network_6_new_return>
NAMED_LOCATIONS = {}
local stale = true
...
---@class megaman_battle_network_6_new_return
...
---@field name string
---@field side string?
---@field exits table<integer, {[1]:megaman_battle_network_6_new_return, [2]:fun(): accessibilityLevel}>
---@field keys integer
...
---@param name string
---@return megaman_battle_network_6_new_return
function megaman_battle_network_6_location.new(name)
	if name == nil then
		error("megaman_battle_network_6_location name cannot be nil")
	end
	if NAMED_LOCATIONS[name] then
		print("megaman_battle_network_6_location " .. name .. " already exists")
	end
    local self = setmetatable({}, megaman_battle_network_6_location)
	self.name = name
...
---@param exit string|megaman_battle_network_6_new_return megaman_battle_network_6_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function megaman_battle_network_6_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = megaman_battle_network_6_location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
---@param exit string|megaman_battle_network_6_new_return megaman_battle_network_6_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function megaman_battle_network_6_location:connect_two_ways(exit, rule)
...
---@param exit string|megaman_battle_network_6_new_return megaman_battle_network_6_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function megaman_battle_network_6_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
---@param exit string|megaman_battle_network_6_new_return megaman_battle_network_6_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function megaman_battle_network_6_location:connect_two_ways_entrance(name, exit, rule)
...
function megaman_battle_network_6_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
---@param rule1? fun(): accessibilityLevel|boolean
---@param rule2? fun(): accessibilityLevel|boolean
function megaman_battle_network_6_location:connect_two_ways_stuck(exit, rule1, rule2)
...
---@return accessibilityLevel
function megaman_battle_network_6_location:accessibility()
...
---@param keys integer
function megaman_battle_network_6_location:discover(accessibility, keys)
...
Entry_Point = megaman_battle_network_6_location.new("Entry_Point")
